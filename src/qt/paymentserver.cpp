...
const QString BITCOIN_IPC_PREFIX("mozzshare:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click mozzshare: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start mozzshare: click-to-pay handler");
    else
...
{
    // clicking on mozzshare: URLs creates FileOpen events on the Mac:
