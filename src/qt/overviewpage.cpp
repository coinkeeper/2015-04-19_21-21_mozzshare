...
{
    ui->labelCurrentReward->setText(QString::number(current) + " MLS");
    if (count > 0)
        ui->labelNextReward->setText(QString::number(next) +" MLS");
    else
    ...
    ui->labelYourVote->setText(QString::number(vote) + " MLS");
    ...
    if (phase == 1) {
       ...
       // ui->labelTarget->setText(QString::number(target) + " MLS");//
		ui->labelTarget->setText(QString::number(current) + " MLS");//TODO
    }
    else if (phase == 2) {
    ...
    ui->labelCurrentSupply->setText(QString::number(supply) + " MLS");
    ui->labelMaxSupply->setText(QString::number(max) + " MLS");
