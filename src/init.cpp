...
void Shutdown()
{
    ...
    RenameThread("mozzshare-shutoff");
...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Parameters
        //
        // If Qt is used, parameters/mozzshare.conf are parsed in qt/bitcoin.cpp's main()
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Mozzshare version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  bitcoind [options]                     " + "\n" +
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "mozzshare:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: mozzshare.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: mozzshared.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 8218 or testnet: 28218)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 8318 or testnet: 28318)") + "\n" +
...
{
    RenameThread("mozzshare-loadblk");
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (fDaemon)
        fprintf(stdout, "Mozzshare server starting\n");
